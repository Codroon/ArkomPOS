...
const es = {
  ...
  "link.open": "Enlazar una caja",
  "link.title": "Enlazar una caja",
  "link.lede": "Genera un código y escríbelo en la caja. Sirve una vez y caduca en 7 días.",
  "link.labelField": "¿Qué caja es? (opcional)",
  "link.labelHint": "Por ejemplo: mostrador, la de arriba",
  "link.issue": "Generar el código",
  "link.issuing": "Generando…",
  "link.codeIs": "Código de enlace",
  "link.onceOnly": "Se enseña UNA vez. No se guarda en ningún sitio, así que no se puede volver a ver: si lo pierdes, genera otro.",
  "link.validUntil": "Caduca el",
  "link.address": "Dirección",
  "link.step1": "En la caja, abre Ajustes → Nube.",
  "link.step2": "Escribe la dirección de arriba donde pone la dirección de la nube.",
  "link.step3": "Pega el código y pulsa Enlazar la caja.",
  "link.step4": "Lo que ya haya vendido sube solo. No hay que esperar.",
  "link.copy": "Copiar",
  "link.copied": "Copiado",
...
const en: Record<MessageKey, string> = {
  ...
  "link.open": "Link a till",
  "link.title": "Link a till",
  "link.lede": "Generate a code and type it into the till. It works once and expires in 7 days.",
  "link.labelField": "Which till is it? (optional)",
  "link.labelHint": "For example: counter, upstairs",
  "link.issue": "Generate the code",
  "link.issuing": "Generating…",
  "link.codeIs": "Enrolment code",
  "link.onceOnly": "Shown ONCE. It is not stored anywhere, so it cannot be shown again — if you lose it, generate another.",
  "link.validUntil": "Valid until",
  "link.address": "Address",
  "link.step1": "On the till, open Ajustes → Nube.",
  "link.step2": "Type the address above where it asks for the cloud address.",
  "link.step3": "Paste the code and press Enlazar la caja.",
  "link.step4": "Everything already sold goes up on its own. There is nothing to wait for.",
  "link.copy": "Copy",
  "link.copied": "Copied",

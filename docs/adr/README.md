...
| [0015](0015-cash-shifts-derived-status-and-one-drawer-truth.md) | Shift status derived from facts; sale cash never copied into the drawer ledger; the Z is frozen | Proposed |
